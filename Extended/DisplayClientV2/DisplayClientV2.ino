...
#define GAMEPAD_AXIS_CLUTCH_ENABLED 0                 //{"Name":"GAMEPAD_AXIS_CLUTCH_ENABLED","Title":"Paddle clutch enabled","DefaultValue":"0","Type":"bool"}
...
#define GAMEPAD_AXIS_CLUTCH_BITEPOINT_TYPE 0          //{"Name":"GAMEPAD_AXIS_CLUTCH_BITEPOINT_TYPE","Title":"Paddle clutch bite point type","DefaultValue":"0","Type":"list","Condition":"GAMEPAD_AXIS_CLUTCH_ENABLED>0","ListValues":"0,Potentiometer;1,Button;2,RaceX plugin"}
...
#define GAMEPAD_AXIS_CLUTCH_BITEPOINT_BUTTON_TYPE 0   //{"Name":"GAMEPAD_AXIS_CLUTCH_BITEPOINT_BUTTON_TYPE","Title":"Paddle clutch bite point button pullup","DefaultValue":"0","Type":"bool","Condition":"GAMEPAD_AXIS_CLUTCH_ENABLED>0&&GAMEPAD_AXIS_CLUTCH_BITEPOINT_TYPE==1"}
...
#define ENCODER1_STEPS_TYPE 0        //{"Name":"ENCODER1_STEPS_TYPE","Title":"Encoder 1 steps mode","DefaultValue":"0","Type":"list","Condition":"ENABLED_ENCODERS_COUNT>=1","ListValues":"0,Full steps;1,Half steps;2,Quarter steps"}
...
#define ENCODER2_BUTTON_PIN 9       //{"Name":"ENCODER2_BUTTON_PIN","Title":"Encoder 2 button (SW) pin","DefaultValue":"13","Type":"pin;Encoder 2 SWITCH","Condition":"ENABLED_ENCODERS_COUNT>1","Min":-1}
...
#define ENCODER2_STEPS_TYPE 0        //{"Name":"ENCODER2_STEPS_TYPE","Title":"Encoder 2 steps mode","DefaultValue":"0","Type":"list","Condition":"ENABLED_ENCODERS_COUNT>1","ListValues":"0,Full steps;1,Half steps;2,Quarter steps"}
...
#define ENCODER3_STEPS_TYPE 0        //{"Name":"ENCODER3_STEPS_TYPE","Title":"Encoder 3 steps mode","DefaultValue":"0","Type":"list","Condition":"ENABLED_ENCODERS_COUNT>2","ListValues":"0,Full steps;1,Half steps;2,Quarter steps"}
...
#define ENCODER4_STEPS_TYPE 0        //{"Name":"ENCODER4_STEPS_TYPE","Title":"Encoder 4 steps mode","DefaultValue":"0","Type":"list","Condition":"ENABLED_ENCODERS_COUNT>3","ListValues":"0,Full steps;1,Half steps;2,Quarter steps"}
...
#define ENCODER5_STEPS_TYPE 0        //{"Name":"ENCODER5_STEPS_TYPE","Title":"Encoder 5 steps mode","DefaultValue":"0","Type":"list","Condition":"ENABLED_ENCODERS_COUNT>4","ListValues":"0,Full steps;1,Half steps;2,Quarter steps"}
...
#define ENCODER6_STEPS_TYPE 0        //{"Name":"ENCODER6_STEPS_TYPE","Title":"Encoder 6 steps mode","DefaultValue":"0","Type":"list","Condition":"ENABLED_ENCODERS_COUNT>5","ListValues":"0,Full steps;1,Half steps;2,Quarter steps"}
...
#define ENCODER7_STEPS_TYPE 0        //{"Name":"ENCODER7_STEPS_TYPE","Title":"Encoder 7 steps mode","DefaultValue":"0","Type":"list","Condition":"ENABLED_ENCODERS_COUNT>6","ListValues":"0,Full steps;1,Half steps;2,Quarter steps"}
...
#define ENCODER8_STEPS_TYPE 0        //{"Name":"ENCODER8_STEPS_TYPE","Title":"Encoder 8 steps mode","DefaultValue":"0","Type":"list","Condition":"ENABLED_ENCODERS_COUNT>7","ListValues":"0,Full steps;1,Half steps;2,Quarter steps"}
...
#ifdef  INCLUDE_ENCODERS
void InitEncoders() {
	if (ENABLED_ENCODERS_COUNT > 0) encoder1.begin(ENCODER1_CLK_PIN, ENCODER1_DT_PIN, ENCODER1_BUTTON_PIN, ENCODER1_REVERSE_DIRECTION, ENCODER1_ENABLE_PULLUP, 1, ENCODER1_STEPS_TYPE, EncoderPositionChanged);
	if (ENABLED_ENCODERS_COUNT > 1) encoder2.begin(ENCODER2_CLK_PIN, ENCODER2_DT_PIN, ENCODER2_BUTTON_PIN, ENCODER2_REVERSE_DIRECTION, ENCODER2_ENABLE_PULLUP, 2, ENCODER2_STEPS_TYPE, EncoderPositionChanged);
	if (ENABLED_ENCODERS_COUNT > 2) encoder3.begin(ENCODER3_CLK_PIN, ENCODER3_DT_PIN, ENCODER3_BUTTON_PIN, ENCODER3_REVERSE_DIRECTION, ENCODER3_ENABLE_PULLUP, 3, ENCODER3_STEPS_TYPE, EncoderPositionChanged);
	if (ENABLED_ENCODERS_COUNT > 3) encoder4.begin(ENCODER4_CLK_PIN, ENCODER4_DT_PIN, ENCODER4_BUTTON_PIN, ENCODER4_REVERSE_DIRECTION, ENCODER4_ENABLE_PULLUP, 4, ENCODER4_STEPS_TYPE, EncoderPositionChanged);
	if (ENABLED_ENCODERS_COUNT > 4) encoder5.begin(ENCODER5_CLK_PIN, ENCODER5_DT_PIN, ENCODER5_BUTTON_PIN, ENCODER5_REVERSE_DIRECTION, ENCODER5_ENABLE_PULLUP, 5, ENCODER5_STEPS_TYPE, EncoderPositionChanged);
	if (ENABLED_ENCODERS_COUNT > 5) encoder6.begin(ENCODER6_CLK_PIN, ENCODER6_DT_PIN, ENCODER6_BUTTON_PIN, ENCODER6_REVERSE_DIRECTION, ENCODER6_ENABLE_PULLUP, 6, ENCODER6_STEPS_TYPE, EncoderPositionChanged);
	if (ENABLED_ENCODERS_COUNT > 6) encoder7.begin(ENCODER7_CLK_PIN, ENCODER7_DT_PIN, ENCODER7_BUTTON_PIN, ENCODER7_REVERSE_DIRECTION, ENCODER7_ENABLE_PULLUP, 7, ENCODER7_STEPS_TYPE, EncoderPositionChanged);
	if (ENABLED_ENCODERS_COUNT > 7) encoder8.begin(ENCODER8_CLK_PIN, ENCODER8_DT_PIN, ENCODER8_BUTTON_PIN, ENCODER8_REVERSE_DIRECTION, ENCODER8_ENABLE_PULLUP, 8, ENCODER8_STEPS_TYPE, EncoderPositionChanged);
}
#endif
